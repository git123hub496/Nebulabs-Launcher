...
export type AppId = 'home' | 'settings' | 'appstore' | 'camera' | 'weather' | 'music' | 'messages' | 'calendar' | 'browser' | 'profile' | 'paint' | 'snake' | 'minesweeper' | 'emails' | 'calculator' | 'notes' | 'quadrais-ai' | 'computer-hub' | 'maps' | 'photos';
